...
import { retryFailedTicketMails } from '#services/ticket_mail_retry_service'

// Remplace les commandes ace `payment-attempts:expire` et `ticket-mails:retry`
...
runPeriodically('ticket-mails:retry', retryFailedTicketMails)
