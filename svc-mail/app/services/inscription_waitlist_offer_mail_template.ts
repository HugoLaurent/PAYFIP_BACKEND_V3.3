...
// Corail réservé au bouton d'action — une place s'est libérée, le
// citoyen doit confirmer avant l'échéance de 48h sous peine de la perdre.
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 1px 3px rgba(18,27,41,.08);">
          ...
          <tr><td style="padding:22px 32px 0;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:${CORAL_TINT}; border-radius:12px;">
              <tr><td style="padding:16px 20px;">
                <div style="font-size:11px; font-weight:600; letter-spacing:1.4px; color:${CORAL};">CONFIRMEZ AVANT LE</div>
                <div style="padding-top:6px; font-size:20px; font-weight:800; color:${CORAL};">${escapeHtml(data.waitlistResponseDeadline)}</div>
              </td></tr>
            </table>
          </td></tr>
          ...
          <tr><td align="center" style="padding:20px 32px 0; font-size:13px; line-height:20px; color:#7b8189;">Passé ce délai, votre place sera proposée à la personne suivante sur la liste d'attente.</td></tr>
