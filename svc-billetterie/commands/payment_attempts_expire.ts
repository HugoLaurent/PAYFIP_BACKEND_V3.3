...
export default class PaymentAttemptsExpire extends BaseCommand {
  ...
  static description =
    "Marque expirée toute tentative de paiement encore en attente au-delà de la validité PayFiP (15 min) — déclenchement manuel/ops, le serveur HTTP le fait déjà automatiquement toutes les 5 min"
