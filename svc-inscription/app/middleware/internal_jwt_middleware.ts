...
// webhook de paiement) — mêmes deux clés que svc-billetterie. Voir
// svc-auth/internal_jwt_middleware.ts pour le raisonnement complet : le
// kid annoncé choisit la clé exacte à vérifier, et le scope du payload
// doit figurer dans ce que ce kid a le droit de déclarer.
