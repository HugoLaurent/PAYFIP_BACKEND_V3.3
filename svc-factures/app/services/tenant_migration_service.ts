...
/**
 * Migre UNE base tenant déjà enregistrée dans db.manager (voir
 * tenant_connection_service.ts / tenant_provision.ts). Ne ferme JAMAIS la
 * connexion elle-même via runner.close() — cette méthode appelle
