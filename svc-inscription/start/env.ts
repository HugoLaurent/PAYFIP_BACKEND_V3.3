...
export default await Env.create(new URL('../', import.meta.url), {
  ...
  INSCRIPTION_JWT_PRIVATE_KEY: Env.schema.string(),
  ...
  // Alerte Teams envoyée quand un email d'inscription abandonne après 24h
  // d'échecs (voir registration_mail_service.ts) — absent en dev, l'alerte
  // reste inerte.
