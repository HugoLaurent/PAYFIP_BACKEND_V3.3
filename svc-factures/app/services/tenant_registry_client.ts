 ...
 * absent du cache (un serviceId inconnu reste inconnu tant que l'annuaire
 * ne l'a pas vu, pas la peine de retaper svc-auth à chaque requête ratée).
 */
 ...
 * visible aux autres services via GET /tenant-databases/:appName (voir
 * tenant_databases_controller.ts côté svc-auth). Appelé une fois les
 * migrations passées avec succès, jamais avant.
 */
