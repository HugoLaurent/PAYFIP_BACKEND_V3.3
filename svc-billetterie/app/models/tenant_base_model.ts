...
/**
 * Base commune aux modèles vivant dans une base par service (Order,
 * Ticket, OrderLine, Tariff, FailedTicketMail) : chaque méthode statique
 ...
 * générique dans cette version de Lucid, même si l'implémentation reste
 * correcte au runtime.
 */
